...
if view == "Leaderboard":
    ...
    _ref_intent = _pick(df_f, globals().get("referral_intent_source_col", None),
                        ["Referral Intent Source","ReferralIntentSource","Referral Intent","Intent Source (Referral)","Referral Source Intent"])
    ...
    is_referral_src = base["SRC"].str.lower().str.strip().eq("referral")
